...
The reference adapter example at `examples/ecb_offline.py` parses the committed ECB fixture at `tests/fixtures/ecb_eurofxref_2026-09-18.xml` without a live network call:

```bash
python examples/ecb_offline.py
```
